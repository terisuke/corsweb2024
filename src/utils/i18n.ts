...
const translations = {
  ja: {
    ...
    nav: { home: "ホーム", about: "Cor.株式会社について", products: "事業と読みもの", blog: "ブログ", contact: "お問い合わせ", security: "セキュリティ", works: "実績・事例", grift: "Grift" },
    hero: {
      title: "言葉を超えて、想いを届ける。",
    ...
    contact: {
      title: "まずは、業務の「進まない」をお聞かせください。",
      description1: "内容を確認のうえ、原則3営業日以内に担当者よりご連絡します。",
      description2: "上記期間内に返信がない場合は、送信トラブルの可能性がございます。お手数をおかけいたしますが、再度ご連絡いただけますようお願い申し上げます。",
      heading: {
        title: "まずは、業務の「進まない」をお聞かせください。",
        description: "具体的に何が決まっていなくても問題ありません。業務の無駄、使いにくいシステム、AI導入、機密データの扱い方、Grift、ローカルLLM、AI開発・研修まで、目的に合わせて整理します。内容を確認のうえ、原則3営業日以内にご連絡します。"
      },
      form: {
        title: "相談内容を教えてください",
        description1: "具体的に何が決まっていなくても問題ありません。目的に合わせて整理します。",
        description2: "内容を確認のうえ、原則3営業日以内に担当者よりご連絡します。",
        fields: {
          name: "お名前",
          email: "メールアドレス",
    ...
    contactChat: {
      ...
      intro: "相談内容の整理にAIアシスタントを利用できます。ただし、氏名、連絡先、契約情報、顧客名、社外秘情報などは入力しないでください。正式なご相談はフォームから受け付けています。",
      piiNotice: "※こちらのチャットは外部のAIモデルを利用しています。個人情報や自社の機密情報は入力しないようお願いいたします。機密データの扱い方から設計するセキュアAI基盤については、上記のお問い合わせフォームよりご相談ください。",
      ...
      success: "お問い合わせを受け付けました。内容を確認のうえ、原則3営業日以内に担当者よりご連絡いたします。ご入力いただいたメールアドレス宛に自動返信メールを送信しておりますので、ご確認ください。",
    ...
    footer: {
      ...
      description: "Cor.株式会社は、機密データAI・ローカルLLM・Griftを軸に、課題整理から設計・実装・運用まで伴走する福岡発のAI実装会社です。",
      copyright: "Cor.inc"
    },
    features: {
      title: "Features",
      ...
      questions: [
        {
          ...
          answer: "弊社では、機密データAI、ローカルLLM・セキュアAI、AI見積支援ツール「Grift」、AI受託開発・AI導入支援を中心に、課題の整理から設計・実装・運用まで一気通貫でご相談いただけます。"
        },
        {
          question: "AI導入は、まず何から始めるべきですか？",
          answer: "まずは現場の「困りごと」や「やりたいこと」をヒアリングし、課題を一緒に整理するところから始めます。扱うデータや業務フローに合わせて、小さく試す PoC に進むか、本格的な実装に進むか、あるいは「まだ作らない方がいい」かを含めてフラットにご提案します。"
        },
        {
          question: "クラウドAIとローカルLLMはどう使い分けますか？",
          answer: "情報の機密度に応じて使い分けます。一般的な作業にはクラウドAIを、契約書や顧客情報など外部AIに出しにくい機密データにはローカルLLMを活用し、情報を業務で使える形へ設計します。"
        },
        {
          question: "機密データAI活用診断では何を行いますか？",
          answer: "御社がお持ちの機密データが、AIでどのように活用できるか、どのような業務効率化につながるかを診断します。機密データの扱い方から設計し、実務で使えるセキュアなAI基盤の構築をご提案します。",
          linkHref: "/works/confidential-data-ai-assessment",
          linkLabel: "診断の詳しい進め方を見る"
        },
        {
          question: "ローカルLLMやAI基盤PoCはどのくらいの期間・費用ですか？",
          answer: "解決したい課題や内容により変動しますが、目安は以下の通りです。\n・機密データAI活用診断: 10万〜30万円程度\n・ローカルLLM / AI基盤PoC: 3ヶ月300万円〜\n・本番構築・運用保守: 要件に応じて個別見積もり\n必要に応じて、自社プロダクト「Grift」で検証している見積根拠の整理手法も活用しながら、前提条件・リスク・作業範囲が分かる形でお見積りします。",
          linkHref: "/works/local-llm-poc",
          linkLabel: "PoCの進め方を見る"
        },
        {
          question: "セキュリティやプライバシーはどのように扱いますか？",
          answer: "入力データの管理、アクセス権限、操作ログの取得、人間による承認フロー、削除ルール、運用責任の所在など、実務上の要件を組み込んで設計します。また、弊社内の体制として ISMS の運用を整備中であり、ISO/IEC 27001認証の取得を目標に情報セキュリティ管理を強化しています。"
        },
        {
          question: "Griftとは何ですか？",
          answer: "受託開発における「見積もりの根拠」を可視化するAI見積支援ツールです。AIに見積もりを丸投げするのではなく、人間が責任を持って説明できる根拠を増やし、属人化しがちな見積ノウハウを会社の資産に変えるプロダクトです。現在 Team Beta 検証中です。",
          linkHref: "/works/grift",
          linkLabel: "Griftの事例を見る"
        }
      ]
    },
    calendar: {
    ...
    meta: {
      home: {
        title: "Cor.株式会社｜機密データAI・ローカルLLMの実装パートナー",
        description: "福岡発のAI実装会社、Cor.株式会社。機密データの扱い方から設計するローカルLLMやセキュアAI、見積支援ツール「Grift」を軸に、業務課題の整理から実装・運用までワンストップで伴走します。必要なら「作らない」選択肢も提案します。",
      ...
      works: { title: "実績 | Cor.株式会社", description: "Cor.株式会社の実績紹介。お客様の業務課題を、課題・設計・実装・運用の軸で解決した事例を掲載。機密データAI・ローカルLLM・Griftを軸に、AIを使う前の情報設計から伴走します。" },
    ...
    homeChallenges: {
      ...
      ctaSecondary: "まず課題を相談する"
    },
    griftBridge: {
      eyebrow: "Try Our AI / Grift",
      title: "見積もりの「なぜ？」をクリアにするAI見積支援ツール『Grift』",
      description: "AIに見積もりを丸投げするのではなく、人間が責任を持って説明できる根拠を増やすプロダクトです。属人化しがちな見積ノウハウを、会社の資産に変えていきます。現在 Team Beta 検証中です。",
      cta: "Griftについて聞く",
    ...
    proof: {
      ...
      stats: [
        ...
        { label: "入口診断", value: "10万〜30万円", note: "機密データAI活用診断", href: "/works/confidential-data-ai-assessment" },
        { label: "PoC構築", value: "3ヶ月300万円〜", note: "ローカルLLM・AI基盤PoC", href: "/works/local-llm-poc" }
      ],
      cta: "AI基盤PoCを相談する"
    },
    services2026: {
      title: "業務に入るAIを、設計から運用まで。",
      items: [
        { name: "PoCで終わらせない、業務に入るAI開発。", description: "生成AI、RAG、AIエージェント、画像・音声処理などを使い、現場の業務に組み込めるAIシステムを設計・実装します。扱うデータ、権限、ログ、人間承認、運用責任まで含めて整理します。" },
        { name: "AIを使う前の、判断基準づくりから。", description: "経営、管理部門、開発チーム、現場担当者に合わせて、AI活用方針、社内ルール、ツール選定、導入手順を整理します。研修だけで終わらせず、実務への接続を重視します。" },
        { name: "機密データの扱い方から設計するAI基盤。", description: "契約書、議事録、顧客情報、見積書、社内ナレッジなど、外部AIに出しにくい情報を業務で使える形へ。クラウドAIとローカルLLMを、情報の機密度に応じて使い分けます。" },
        { name: "見積根拠を、会社の資産に。", description: "Griftは、受託開発の見積根拠を可視化するAI見積支援ツールです。AIに丸投げするのではなく、人間が責任を持って説明できる根拠を増やします。現在 Team Beta 検証中です。" }
      ]
    },
    securityTrust: {
      title: "実務上の不安に対応するセキュリティ設計",
      description: "入力データ、アクセス権限、操作ログから、人間承認、削除ルール、運用責任の所在まで。機密データを扱う上で生じる実務上の不安に、適切な設計で対応します。",
      items: [
    ...
    kyousou: {
      title: "作ることが目的ではありません。必要なら「まだ作らない」と提案します。",
      description: "利益第一ではなく、社会により良いものを生み出すために、競争することもあれば、共創することも、協奏することもある。Cor.株式会社は、多くの意味を含むこの考え方を「きょうそう」と呼んでいます。",
      items: [
    ...
    homeIndustries: {
      ...
      description: "現場ごとに、データの扱い方、業務フロー、判断基準は異なります。いきなり開発に入るのではなく、まずは進め方から一緒に整理します。",
    ...
    works: {
      ...
      items: [
        { name: "見積根拠を会社資産にするAI見積支援ツール『Grift』", tag: "自社プロダクト", description: "AIに見積もりを丸投げせず、人間が責任を持てる根拠を増やす検証中プロダクト。課題：受託開発における見積もりノウハウが属人化し、根拠がブラックボックス化しやすい。設計・実装：過去のデータや前提条件をAIが整理し、人間が確認・修正しやすいUI/UXを設計・実装。運用：担当者の頭の中にあったノウハウを会社の資産に変え、透明性のある見積もり運用を目指して Team Beta 検証中。", href: "https://griftai.org" },
        { name: "Engineer Cafe Navigator", tag: "OSS公開実績", description: "施設情報をもとに、利用者からの質問に自然な対話で答えるAI案内システム。課題：施設に関する多様な質問への対応コストが高く、利用者が情報を探しにくい。設計・実装：公開情報やFAQを整理し、適切な回答を生成するAIチャットボット基盤を設計・実装。運用：オープンソースとして公開し、コミュニティ主導での継続的な改善・運用が可能な体制を目指した。", href: "/works/engineer-cafe-navigator" },
        { name: "画像・テキストを複合的に処理する生成AI SaaS基盤の開発", tag: "AI基盤開発", description: "複数のAIモデルを組み合わせ、目的に応じたコンテンツ生成を自動化するSaaS基盤。課題：画像とテキストを組み合わせたコンテンツ制作に多大な人的コストがかかっている。設計・実装：複数のマルチモーダルAIを統合し、要件に応じた出力を安定して生成するためのAPI連携基盤を設計。運用：エンドユーザーが直感的に操作できるインターフェースを提供し、継続的な機能拡張が可能な運用体制を構築。", href: null, nda: true, note: "※機密保持の観点から、特定につながる情報を伏せて掲載しています。" },
        { name: "大規模アンケート収集・分析基盤の刷新と運用設計", tag: "基幹システム刷新", description: "膨大な回答データを安全かつリアルタイムに処理・分析するためのシステム刷新。課題：既存システムのパフォーマンス低下と、データ分析までのタイムラグ・運用負荷の増大。設計・実装：大量アクセスに耐えうる負荷分散と、セキュアなデータ保管ルールを設計・再実装。運用：操作ログの取得や権限管理を整え、業務で運用する際の不安を減らすデータ管理体制へ移行。", href: "/works/survey-platform-renewal", nda: true, note: "※NDAのため、企業名・製品名・一部仕様を抽象化して掲載しています。" },
        { name: "業務フローに寄り添う、レガシー基幹システムのクラウド移行", tag: "基幹システム刷新", description: "老朽化したオンプレミス環境から、運用を見据えたクラウド環境への移行支援。課題：既存の業務フローが複雑化しており、単なるクラウド移行では現場の混乱が予想された。設計・実装：移行前に現場の業務課題を言語化・整理し、不要な機能を削ぎ落としたうえでクラウドアーキテクチャを設計・実装。運用：運用時に確認すべき責任範囲を明確にし、現場が迷わず使える保守・運用フローを定着。", href: "/works/legacy-core-system-cloud-migration", nda: true, note: "※機密保持の観点から、特定につながる情報を伏せて掲載しています。" },
        { name: "建築図面および間取りの自動生成AIの実証実験", tag: "PoC / 0→1開発", description: "建築業界の専門知識とAIを掛け合わせ、設計初期段階の図面作成を支援する検証。課題：設計初期段階における間取り案の作成に時間がかかり、顧客提案のスピードが上がらない。設計・実装：建築基準や特有の設計ルールをAIに扱わせるためのデータ整形ルールを定義し、プロトタイプを設計・実装。運用：生成された図面を人間が最終確認するフローを策定し、実務への組み込み可否を判断。", href: null, nda: true, note: "※NDAのため、企業名・製品名・一部仕様を抽象化して掲載しています。" }
      ]
    },
    security: {
      title: "セキュリティ方針",
  ...
  en: {
    ...
    meta: {
      ...
      home: {
        title: "Cor.Inc. | Practical AI Implementation, Local LLM, and Grift",
        description: "Cor.Inc. builds robust, operational AI systems tailored to your business, centering on confidential data AI, Local LLMs, and Grift, incorporating essential designs for input boundaries, permissions, logs, and human approval.",
        ogTitle: "Cor.Inc. | Practical AI Implementation, Local LLM, and Grift",
        ogDescription: "Cor.Inc. builds robust, operational AI systems tailored to your business, centering on confidential data AI, Local LLMs, and Grift, incorporating essential designs for input boundaries, permissions, logs, and human approval.",
      },
  ...
  zh: {
    ...
    meta: {
      ...
      home: {
        title: "Cor.株式会社｜紧贴业务的AI落地应用・本地LLM・Grift",
        description: "Cor.株式会社以机密数据AI、本地LLM和Grift为核心，全方位设计包含输入边界、权限、日志及人工审批在内的体系，为您构建真正赋能实际业务的AI系统。",
        ogTitle: "Cor.株式会社｜紧贴业务的AI落地应用・本地LLM・Grift",
        ogDescription: "Cor.株式会社以机密数据AI、本地LLM和Grift为核心，全方位设计包含输入边界、权限、日志及人工审批在内的体系，为您构建真正赋能实际业务的AI系统。",
      },
  ...
  ko: {
    ...
    meta: {
      ...
      home: {
        title: "Cor.주식회사｜업무에 직결되는 AI 구현·로컬 LLM·Grift",
        description: "Cor.주식회사는 기밀 데이터 AI, 로컬 LLM, Grift를 축으로 입력 경계·권한·로그·휴먼 승인까지 설계하여, 실제 비즈니스 업무에서 작동하는 AI 시스템을 구축합니다.",
        ogTitle: "Cor.주식회사｜업무에 직결되는 AI 구현·로컬 LLM·Grift",
        ogDescription: "Cor.주식회사는 기밀 데이터 AI, 로컬 LLM, Grift를 축으로 입력 경계·권한·로그·휴먼 승인까지 설계하여, 실제 비즈니스 업무에서 작동하는 AI 시스템을 구축합니다.",
      },
  ...
  es: {
    ...
    meta: {
      ...
      home: {
        title: "Cor.Inc. | Implementación de IA Práctica, LLM Local y Grift",
        description: "Cor.Inc. construye sistemas de IA operativos y adaptados a su negocio, basándose en IA para datos confidenciales, LLM Locales y Grift, e integrando diseños clave como límites de entrada, permisos, registros y aprobación humana.",
        ogTitle: "Cor.Inc. | Implementación de IA Práctica, LLM Local y Grift",
        ogDescription: "Cor.Inc. construye sistemas de IA operativos y adaptados a su negocio, basándose en IA para datos confidenciales, LLM Locales y Grift, e integrando diseños clave como límites de entrada, permisos, registros y aprobación humana.",
      },
