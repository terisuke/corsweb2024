  ...
  ja: {
    ...
    industryShigyo: {
      ...
      support: {
        eyebrow: "02 / Cor.の伴走",
        title: "Cor.は、こう伴走します。",
        intro: "課題ごとに、AI受託開発・AI顧問・ローカルLLM・Griftを組み合わせながら一緒に進めます。断定ではなく、現場の文脈に合わせた伴走を大切にしています。",
        items: [
          {
    ...
    industryConstruction: {
      hero: {
        ...
        subtitle: "労務管理、設計変更、安全確認、ノウハウの継承——現場の段取りが紙とFAXに縛られると、本来の施工そのものが止まります。Cor.は、現場の文脈に合わせて次の一歩を伴走します。"
      },
      challenges: {
        eyebrow: "01 / よくある課題",
    ...
    industryManufacturing: {
      hero: {
        ...
        subtitle: "検査の基準、職人の技、設備の保全、在庫の読み——現場の知恵が人に集中すると、止まる理由は増えていきます。Cor.は、現場の文脈に合わせて次の一歩を伴走します。"
      },
      challenges: {
        eyebrow: "01 / よくある課題",
