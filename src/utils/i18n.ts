...
const translations = {
  ja: {
    ...
    meta: {
      home: { title: "Cor.株式会社｜業務に直結するAI実装・ローカルLLM・Grift", description: "Cor.株式会社は、機密データAI、ローカルLLM、Griftを軸に、入力境界・権限・ログ・人間承認まで設計し、業務で動くAIシステムを構築します。" },
  ...
  en: {
    ...
    meta: {
      ...
      home: { title: "Cor.Inc. | Practical AI Implementation, Local LLM, and Grift", description: "Cor.Inc. builds robust, operational AI systems tailored to your business, centering on confidential data AI, Local LLMs, and Grift, incorporating essential designs for input boundaries, permissions, logs, and human approval." },
  ...
  zh: {
    ...
    meta: {
      ...
      home: { title: "Cor.株式会社｜紧贴业务的AI落地应用・本地LLM・Grift", description: "Cor.株式会社以机密数据AI、本地LLM和Grift为核心，全方位设计包含输入边界、权限、日志及人工审批在内的体系，为您构建真正赋能实际业务的AI系统。" },
  ...
  ko: {
    ...
    meta: {
      ...
      home: { title: "Cor.주식회사｜업무에 직결되는 AI 구현·로컬 LLM·Grift", description: "Cor.주식회사는 기밀 데이터 AI, 로컬 LLM, Grift를 축으로 입력 경계·권한·로그·휴먼 승인까지 설계하여, 실제 비즈니스 업무에서 작동하는 AI 시스템을 구축합니다." },
  ...
  es: {
    ...
    meta: {
      ...
      home: { title: "Cor.Inc. | Implementación de IA Práctica, LLM Local y Grift", description: "Cor.Inc. construye sistemas de IA operativos y adaptados a su negocio, basándose en IA para datos confidenciales, LLM Locales y Grift, e integrando diseños clave como límites de entrada, permisos, registros y aprobación humana." },
